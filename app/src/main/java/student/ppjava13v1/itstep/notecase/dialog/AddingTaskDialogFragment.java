package student.ppjava13v1.itstep.notecase.dialog;
...
public class AddingTaskDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        Spinner spPriority = (Spinner) container.findViewById(R.id.spDialogTask);
        ...
        if (etTime != null) {
            etTime.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    timePickerDialogFragment.show(getFragmentManager(), "TimePickerFragment");
                }
            });
        }
